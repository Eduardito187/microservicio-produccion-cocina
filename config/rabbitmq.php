...
return [
    ...
    'read_write_timeout' => (int) env('RABBITMQ_READ_WRITE_TIMEOUT', 5),
    'inbound' => [
        ...
        'event_aliases' => [
            ...
            'paciente.direccion-creada' => 'DireccionCreada',
            'paciente.direccion-actualizada' => 'DireccionActualizada',
            'paciente.direccion-geocodificada' => 'DireccionGeocodificada',
            'PatientCreatedEvent' => 'PacienteCreado',
            'PatientUpdatedEvent' => 'PacienteActualizado',
            'PatientDeletedEvent' => 'PacienteEliminado',
            'planes.receta-creada' => 'RecetaActualizada',
            ...
            'suscripcion.crear' => 'suscripcion.crear',
            'contrato.generar' => 'SuscripcionCreada',
            'contrato.creado' => 'contrato.creado',
            'contrato.consultar' => 'contrato.consultar',
            'contrato.cancelar' => 'contrato.cancelado',
            'contrato.cancelado' => 'contrato.cancelado',
            'calendario.servicio.generar' => 'calendario.servicio.generar',
            'calendario.generado' => 'calendario.generado',
            'calendarios.crear-dia' => 'CalendarioEntregaCreado',
            'calendarioentrega.creada' => 'calendarios.crear-dia',
            'calendarios.sin-entrega' => 'DiaSinEntregaMarcado',
            'calendarios.direccion-entrega-cambiada' => 'DireccionEntregaCambiada',
            'logistica.paquete.estado-actualizado' => 'logistica.paquete.estado-actualizado',
        ],
    ...
    'event_queues' => [
        ...
        \App\Domain\Produccion\Events\RecetaCreada::class => 'produccion.receta-creada',
        \App\Domain\Produccion\Events\RecetaActualizada::class => 'produccion.receta-actualizada',
